      ...
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="docs-info">
            ...
            <p class="text-xs font-weight-bold">Silahkan hubungi kami pada tombol dibawah</p>
            <a href="   " target="_blank" class="btn btn-white btn-sm w-100 mb-0"> Developer</a>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Pelayanan Kesehatan Digital </p>
                    <h5 class="font-weight-bolder">  Health Plus</h5>
                    <p class="mb-5">Platform manajemen kesehatan yang menyediakan layanan pemesanan dan pencatatan riwayat pemeriksaan medis secara online untuk pasien dan dokter.</p>
                  </div>
                </div>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Info</h5>
                <p class="text-white">Jelajahi fitur terbaru dan layanan aplikasi lebih lanjut </p>
