                    ...
                    <div class="d-flex">
                      <div class="d-flex">
                        <div class="me-4">
                          ...
                          <h6 class="text-white mb-0">Alvin Ahmad</h6>
                        </div>
                        <div>
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Asuransi</h6>
                      <span class="text-xs">Penangganan BPJS</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">-Rp. 30 000</h5>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mt-md-0 mt-4">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      ...
                      <span class="text-xs">Tagihan sementara</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">Rp. 58 000</h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <button class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 btn-sm d-flex align-items-center justify-content-center"><i class="fas fa-arrow-up"></i></button>
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm"> Health Plus Team</h6>
