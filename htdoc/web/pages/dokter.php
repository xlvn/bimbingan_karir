...
$sql = "SELECT id, nama, alamat, no_hp, id_poli FROM dokter";
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="../pages/dokter.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID Poli</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td class='text-xs font-weight-bold'>" . $row["nama"] . "</td>";
                                            echo "<td class='text-xs font-weight-bold text-center'>" . $row["alamat"] . "</td>";
                                            echo "<td class='text-xs font-weight-bold text-center'>" . $row["no_hp"] . "</td>";
                                            echo "<td class='text-xs font-weight-bold text-center'>" . $row["id_poli"] . "</td>";
                                            echo "</tr>";
                                        }
                                    } else {
