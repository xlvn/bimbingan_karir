...
if (!isset($_SESSION['full_name'])) {
    ...
    header("Location: ../pages/sign-in-dokter.php");
    exit();
}

// Nama lengkap pengguna yang login
$full_name = $_SESSION['full_name'];

// Ambil ID dokter dari sesi
$id_dokter = $_SESSION['id_dokter'];

// Query untuk mendapatkan data jadwal_periksa hanya untuk dokter yang sedang login
$sql = "SELECT jp.id, d.nama as dokter, jp.hari, jp.jam_mulai, jp.jam_selesai 
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  " href="../pages/dashboard-dokter.php">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/jadwal.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/riwayat.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="row mt-4">
    <div class="col-lg-12"> <!-- Perbaiki dari col-lg-18 ke col-lg-12 untuk memenuhi sistem grid 12 kolom -->
      <div class="col-lg-12 col-md-12 mb-md-0 mb-4"> <!-- Perbaiki col-lg-8 col-md-6 ke col-lg-12 col-md-12 untuk lebar penuh -->
        <div class="card">
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>";
                                    echo "<td class='text-xs font-weight-bold'>" . $row["dokter"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold'>" . $row["hari"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold text-center'>" . $row["jam_mulai"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold text-center'>" . $row["jam_selesai"] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                        ...
                        <div class="dropdown float-lg-end pe-4">
                            ...
                            <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                                <li><a class="dropdown-item border-radius-md" href="javascript:;">Detail</a></li>
                                <li><a class="dropdown-item border-radius-md" href="javascript:;">Ubah</a></li>
