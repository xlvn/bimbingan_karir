...
// Memeriksa apakah ada permintaan POST dari formulir pop up
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        // Redirect kembali ke halaman obat.php setelah berhasil menambahkan obat
...
// Memeriksa apakah terdapat parameter ID yang dikirimkan melalui URL untuk penghapusan
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    ...
    if ($conn->query($sql) === TRUE) {
        // Redirect kembali ke halaman obat.php setelah berhasil menghapus obat
        header("Location: obat.php");
        exit();
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/dokter.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/poli.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank">Online</a>
            </li>
            <li class="nav-item d-flex align-items-center">
...
<!-- Tambah Form Obat -->
<div class="modal fade" id="tambahObatModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formObat" action="obat.php" method="post">
            <div class="mb-3">
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td class='text-xs font-weight-bold'>" . $row["id"] . "</td>";
        echo "<td class='text-xs font-weight-bold'>" . $row["nama_obat"] . "</td>";
        echo "<td class='text-xs font-weight-bold text-center'>" . $row["kemasan"] . "</td>";
        echo "<td class='text-xs font-weight-bold text-center'>" . $row["harga"] . "</td>";
        echo "<td class='text-xs font-weight-bold text-center'><a href='edit_obat.php?id=" . $row["id"] . "' class='btn btn-third' style='margin-left: 5px; margin-right: 5px;'>Edit</a></td>";
        // Link untuk menghapus obat
        echo "<td class='text-xs font-weight-bold text-center'><a href='obat.php?id=" . $row["id"] . "' class='btn btn-secondary'>Hapus</a></td>";
