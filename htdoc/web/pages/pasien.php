  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/pasien.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td class='text-xs font-weight-bold text-center'>" . $row["no_ktp"] . "</td>";
                                        echo "<td class='text-xs font-weight-bold text-center'>" . $row["no_hp"] . "</td>";
                                        echo "<td class='text-xs font-weight-bold text-center'>" . $row["no_rm"] . "</td>";
                                        echo "</tr>";
                                    }
                                } else {
