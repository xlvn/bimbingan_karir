...
// Query untuk mengambil data dari tabel periksa
$sql = "SELECT id, id_daftar_poli, tgl_periksa, catatan, biaya_periksa FROM periksa";
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/jadwal.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
        <a class="nav-link  active" href="../pages/riwayat.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">ID Daftar Poli</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tanggal Periksa</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Catatan</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Biaya Periksa</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td class='text-xs font-weight-bold'>" . $row["id_daftar_poli"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold text-center'>" . $row["tgl_periksa"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold text-center'>" . $row["catatan"] . "</td>";
                                    echo "<td class='text-xs font-weight-bold text-center'>" . $row["biaya_periksa"] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
